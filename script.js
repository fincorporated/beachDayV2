document.getElementById("go").addEventListener("click", button)
...
async function button() {
    ...
    await getAnswerForToday();
}

async function getAnswerForToday() {
    const stateName = document.getElementById("state").value;
    const citiesURL = getLocation();
    ...
    async function getTides() {
        const stationID = await getTideURL();
